...
geth --datadir qdata/dd1 init poa-genesis.json
...
geth --datadir qdata/dd2 init poa-genesis.json
...
geth --datadir qdata/dd3 init poa-genesis.json
...
geth --datadir qdata/dd4 init poa-genesis.json
