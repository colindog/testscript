...
w3 = Web3(HTTPProvider('http://10.50.0.3:22000'))#http rpc
...
keyfile = open('/root/UTC--2019-01-23T04-55-53.613777100Z--c7f2c2e8ed6ec6cadf621b2c9808dd76b3f60009')
encrypted_key = keyfile.read()
...
base = w3.eth.getTransactionCount(Web3.toChecksumAddress("0xc7f2c2e8ed6ec6cadf621b2c9808dd76b3f60009"))
